...
def _standardize_required_columns(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    # aliases aligned with your upload validator
    ...
    bgy     = _pick_col(df, ["(Current Address) Barangay", "Barangay", "Current Address Barangay", "Address Barangay", "Brgy", "Brgy."])
    ...
    # hard requirements for pipeline correctness
    # hard requirements for pipeline correctness (DOB/Sex optional)
    missing = []
    ...
    # ensure optional columns exist (downstream steps may reference them)
